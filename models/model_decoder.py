...
class model_decoder(nn.Module):
    ...
    def __init__(self, settings, model_pretrained):
        ...
        self.memory_fut_track = torch.Tensor().cuda()
        self.memory_count = []
    ...
    def forward(self, past):
        """
        Forward pass. Predicts future trajectory based on past trajectory and future feature read from memory.
    ...
    def write_in_memory(self, past, future):
        """
        writing past-future feature in the memory with the learnable controller.
        :param past: past trajectory
        :param future: future trajectory
        :return: predicted future
        """
