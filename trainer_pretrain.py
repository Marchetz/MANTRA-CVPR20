...
class Trainer():
    def __init__(self, config):
        ...
        self.writer.add_text('Training Configuration', 'rotation_aug: {}'.format(config.rotation_aug), 0)
    ...
    def evaluate(self, loader, epoch=0):
        ...
        for step, (index, past, future, presents, videos, vehicles, number_vec, scene, scene_one_hot) in enumerate(loader):
            ...
            for i in range(len(past)):
                ...
                # Draw sample
                if loader == self.test_loader and epoch == self.max_epochs and i == 0:
        ...
        dict_metrics['euclidean_mean'] = euclidean_mean / len(loader.dataset)
    ...
    def _train_single_epoch(self):
        ...
        """
        config = self.config
        for step, (index, past, future, presents, videos, vehicles, number_vec, scene, scene_one_hot) in enumerate(self.train_loader):
            self.iterations += 1
